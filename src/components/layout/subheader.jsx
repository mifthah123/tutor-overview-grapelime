  ...
  return (
    <div className="subheader-container">
      <div className="subheader-left">
        <span className="subheader-title">Tutor Dashboard</span>
        <div className="subheader-nav">
          {navItems.map((item) => (
            <>
              ...
              >
                <span className="subheader-icon">{item.icon}</span>
                <span className="subheader-text">{item.name}</span>
              </div>
            </>
          ))}
        </div>
